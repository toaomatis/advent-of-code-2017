...
val day2Input = "4347\t3350\t196\t162\t233\t4932\t4419\t3485\t4509\t4287\t4433\t4033\t207\t3682\t2193\t4223\n" +
...
class Day2Dot1 : AdventOfCode {

    override fun solve() {
        var solution = 0

        for (line in day2Input.split("\n")) {
...
class Day2Dot2 : AdventOfCode {
    ...
    override fun solve() {
        ...
        for (line in day2Input.split("\n")) {
            for (cell1 in line.split("\t")) {
                for (cell2 in line.split("\t")) {
                    val int1 = cell1.toInt()
